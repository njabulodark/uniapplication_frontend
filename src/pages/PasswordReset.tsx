...
export default function PasswordReset() {
  ...
  useEffect(() => {
    document.title = "Reset Password — University Portal";
    ...
    <div className="flex flex-col min-h-screen bg-slate-950">
      ...
      <main className="flex-1 relative flex items-center justify-center px-4 py-12 sm:py-16 md:py-20 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[420px]">
          {/* Card */}
          <div
            className="relative bg-white/[0.07] backdrop-blur-2xl rounded-3xl border border-white/[0.08] shadow-[0_8px_64px_rgba(0,0,0,0.4)] overflow-hidden"
          >
